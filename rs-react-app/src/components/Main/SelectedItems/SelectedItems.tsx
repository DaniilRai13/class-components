...
const SelectedItems: FC = () => {
	...
	return (
		<>
			{!!isDisabled && <section className={styles.selected}>
				<div className={styles.header}>
					<h3 className={styles.title}>Selected {markedPeoples.length} Items:</h3>
				...
				<div className={styles.list}>
					{markedPeoples.map((item) => <ListItem key={item.url} item={item} />)}
				</div>
			</section>
			}
		</>
